...
namespace EpicBcaOverlay
{
    ...
    {
        // ---- Customize here ----
        private const string BorderText = "EPIC BCA - Please use during Epic downtime";
        private const int TopBottomThickness = 8; // px, thicker — carries the text
        private const int SideThickness = 3;        // px, thinner — no text
